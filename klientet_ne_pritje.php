...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['rezervim_id'], $_POST['status'])) {
    ...
    try {
        ...
        header("Location: klientet_ne_pritje.php"); // Refresh për të reflektuar ndryshimet
        exit;
    } catch (PDOException $e) {
...
// Shfaq klientët që i kanë bërë rezervim këtij mjeshtri
try {
    $stmt = $pdo->prepare("
        ...
        WHERE r.mjeshter_id = :mjeshter_id
